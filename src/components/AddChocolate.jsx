...
const AddChocolate = () => {
    ...
    return (
        <div className='px-20  mt-10'>
            <h1 className='text-center text-2xl font-semibold'>New Chocolates</h1>
            <p className='text-center text-gray-700 font-semibold'>Use the below form to create a new product</p>
